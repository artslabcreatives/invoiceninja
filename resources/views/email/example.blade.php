...
@component('email.components.button', ['url' => 'https://hypesl.org', 'show_link' => true])
    Visit InvoiceNinja
@endcomponent
...
@slot('footer')
    @component('email.components.footer', ['url' => 'https://hypesl.org', 'url_text' => '&copy; InvoiceNinja'])
