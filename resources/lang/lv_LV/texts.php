...
<li>"Noguldītāju maksājums par: CETURTĀ + 1" >> "Noguldītāju maksājums par Q2" </li>
    ...
    'email_from' => 'The Hype Sri Lanka komanda',
    ...
    'agree_to_terms' => 'I agree to the Hype Sri Lanka :terms',
    ...
    'pro_plan_success' => 'Thanks for choosing Hype Sri Lanka\'s Pro plan!<p/>&nbsp;<br/>
    ...
    'app_description' => 'Hype Sri Lanka is a free, open-source solution for invoicing and billing customers. With Hype Sri Lanka, you can easily build and send beautiful invoices from any device that has access to the web. Your clients can print your invoices, download them as pdf files, and even pay you online from within the system.',
    'rows' => 'rows',
    'www' => 'www',
    'logo' => 'Logo',
    'subdomain' => 'Subdomain',
    ...
    'pro_plan_feature4' => 'Remove "Created by Hype Sri Lanka"',
    ...
    'white_label_text' => 'Purchase a ONE YEAR white label license for $:price to remove the Hype Sri Lanka branding from the invoice and client portal.',
    ...
    'pro_plan_remove_logo' => ':link to remove the Hype Sri Lanka Logo by joining the Pro Plan',
    ...
    'pro_plan_year_description' => 'One year enrollment in the Hype Sri Lanka Pro Plan.',
    'pro_plan_month_description' => 'One month enrollment in the Hype Sri Lanka Pro Plan.',
    'enterprise_plan_product' => 'Enterprise Plan',
    'enterprise_plan_year_description' => 'One year enrollment in the Hype Sri Lanka Enterprise Plan.',
    'enterprise_plan_month_description' => 'One month enrollment in the Hype Sri Lanka Enterprise Plan.',
    ...
    'export_help' => 'Izmantojiet JSON, ja plānojat importēt datus Hype Sri Lanka.<br/>Fails ietver klientus, produktus, rēķinus, piedāvājumus un maksājumus.',
    ...
    'wepay_account_description' => 'Payment gateway for Hype Sri Lanka',
    ...
    'security_code_email_subject' => 'Security code for Hype Sri Lanka Bot',
    'security_code_email_line1' => 'This is your Hype Sri Lanka Bot security code.',
    ...
    'update_invoiceninja_title' => 'Update Hype Sri Lanka',
    'update_invoiceninja_warning' => 'Before start upgrading Hype Sri Lanka create a backup of your database and files!',
    'update_invoiceninja_available' => 'A new version of Hype Sri Lanka is available.',
    'update_invoiceninja_unavailable' => 'No new version of Hype Sri Lanka available.',
...
<ul><li>Flexible business lines of credit and invoice factoring.</li></ul>',
    ...
    'migrate_to_next_version' => 'Migrate to the next version of Hype Sri Lanka',
    'migrate_intro_text' => 'We\'ve been working on next version of Hype Sri Lanka. Click the button bellow to start the migration.',
    'start_the_migration' => 'Start the migration',
    'migration' => 'Migration',
    'welcome_to_the_new_version' => 'Welcome to the new version of Hype Sri Lanka',
    ...
    'copy_link' => 'Copy Link',
    'welcome_to_invoice_ninja' => 'Welcome to Hype Sri Lanka',
    'optin' => 'Opt-In',
    'optout' => 'Opt-Out',
    ...
    'complete' => 'Complete',
     ...
     'application_settings_label' => 'Let\'s store basic information about your Hype Sri Lanka!',
     ...
     'migration_api_secret_notice' => 'You can find API_SECRET in the .env file or Hype Sri Lanka v5. If property is missing, leave field blank.',
    ...
    'stripe_connect_migration_desc' => 'Hype Sri Lanka v5 uses Stripe Connect to link your Stripe account to Hype Sri Lanka. This provides an additional layer of security for your account. Now that you data has migrated, you will need to Authorize Stripe to accept payments in v5.<br><br>To do this, navigate to Settings > Online Payments > Configure Gateways. Click on Stripe Connect and then under Settings click Setup Gateway. This will take you to Stripe to authorize Hype Sri Lanka and on your return your account will be successfully linked!',
