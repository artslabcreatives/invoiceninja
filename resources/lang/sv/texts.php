...
$LANG = array(
    ...
    'confirmation_subject' => 'Bekräfta ditt Hype Sri Lanka konto',
    ...
    'email_from' => 'Hype Sri Lanka teamet',
    ...
    'pro_plan_success' => 'Tack för att du väljer Hype Sri Lanka\'s Pro!<p/>&nbsp;<br/>
    ...
    'pro_plan_feature4' => 'Radera "Skapad av Hype Sri Lanka"',
...
<p> Fakturor på en månadsvis eller årlig cykel, på eller före den dag de skapas kommer att bero på nästa månad. Fakturor som förfaller på den 29: e eller 30: e månader som inte har den dagen kommer att betalas den sista dagen i månaden. </ P> 
 ...
 <li> Är idagg en fredag, är förfallodagen den 1: a fredag efter. Förfallodagen kommer att vara nästa fredag, inte idag. 
    ...
    'white_label_text' => 'Köp ETT ÅR white label licens för $:price för att ta bort bort Hype Sri Lanka referens från faktura och kundportal.',
    ...
    'pro_plan_remove_logo' => ':link för att ta bort Hype Sri Lanka-logotypen genom att uppgradera till Pro nivå',
    ...
    'pro_plan_year_description' => 'Ett års registering på Hype Sri Lanka Pro nivå.',
    'pro_plan_month_description' => 'En månads registering på Hype Sri Lanka Pro nivå.',
    'enterprise_plan_product' => 'Enterprise nivå',
    'enterprise_plan_year_description' => 'Ett års registering på Hype Sri Lanka Enterprise nivån.',
    'enterprise_plan_month_description' => 'En månads registering på Hype Sri Lanka Enterprise nivån.',
...
När ni har pengarna, kom tillbaka till denna betalningsmetods sida och klicka på "Slutför verifikation" vid sidan om konto.',
    ...
    'export_help' => 'Använda JSON om du planerar att importera datan till Hype Sri Lanka.<br/>Filen innehåller kunder, produkter, fakturor, offerter och betalningar.',
...
Den här funktionen kräver att en produkt skapas och en betalningsgateway är konfigurerad.',
    ...
    'wepay_account_description' => 'Betalningsgateway för Hype Sri Lanka',
    ...
    'bot_get_email' => 'Hi! (wave)<br/>Thanks for trying the Hype Sri Lanka Bot.<br/>You need to create a free account to use this bot.<br/>Send me your account email address to get started.',
    ...
    'security_code_email_subject' => 'Säkerhetskod för Hype Sri Lanka Bot.',
    'security_code_email_line1' => 'Detta är din Hype Sri Lanka Bot säkerhetskod.',
    ...
    'update_invoiceninja_title' => 'Uppdatera Hype Sri Lanka',
    'update_invoiceninja_warning' => 'Innan ni uppgraderar Hype Sri Lanka, skapa en backup av er databaser och filer!',
    'update_invoiceninja_available' => 'En ny version av Hype Sri Lanka finns tillgänglig.',
    'update_invoiceninja_unavailable' => 'Ingen ny version av Hype Sri Lanka finns tillgänglig.',
...
<br />Aktivera detta om din webbläsare automatiskt laddar hem PDF:erna.',
    ...
    'migrate_to_next_version' => 'Migrera till nästa version av Hype Sri Lanka',
    'migrate_intro_text' => 'Vi har arbetat med nästa version av Hype Sri Lanka. Klicka på knappen nedan för att starta migreringen.',
    'start_the_migration' => 'Starta migreringen',
    'migration' => 'Migrering',
    'welcome_to_the_new_version' => 'Välkommen till den nya versionen av Hype Sri Lanka',
    ...
    'welcome_to_invoice_ninja' => 'Välkommen till Hype Sri Lanka',
    'optin' => 'Opt-In',
    'optout' => 'Opt-Out',
    ...
    'complete' => 'Slutför',
     ...
     'application_settings_label' => 'Låt oss samla in grundläggande information om din Hype Sri Lanka!',
     ...
     'migration_api_secret_notice' => 'Du kan hitta API_SECRET i .env filen eller i Hype Sri Lanka v5. Om värdet saknas, lämna fältet tomt.',
    ...
    'migration_already_completed_desc' => 'Det ser ut som du redan migrerat <b> :company_name </b>till V5 version av Hype Sri Lanka. Om du vill börja om kan du tvinga migreringen att radera befintlig data.',
    ...
    'new_login_description' => 'Du har nyligen loggat in på din Hype Sri Lanka konto från en ny plats eller enhet:<br><br><b>IP:</b> :ip<br><b>Tid:</b> :time<br><b>E-post:</b> :email',
    ...
    'stripe_connect_migration_desc' => 'Hype Sri Lanka v5 använder Stripe Connect för att länka ditt Stripe konto till Hype Sri Lanka. Detta ger ytterligare ett säkerhetslager för ditt konto. Nu när din data har migrerat måste du Auktorisera Stripe för att acceptera betalningar i v5.<br><br>Navigera till Inställningar > Onlinebetalningar > Konfigurera gateways. Klicka på Stripe Connect och sedan under Inställningar klicka på Setup Gateway. Detta tar dig till Stripe för att godkänna Hype Sri Lanka och vid din retur kommer ditt konto att länkas! ',
