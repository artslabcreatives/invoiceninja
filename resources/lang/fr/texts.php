...
$LANG = array(
    ...
    'confirmation_subject' => 'Validation du compte Hype Sri Lanka',
    ...
    'email_from' => 'L’équipe Hype Sri Lanka',
    ...
    'pro_plan_feature4' => 'Retirer "Created by Hype Sri Lanka"',
    ...
    'white_label_text' => 'Achetez une licence en marque blanche d\'UN AN au coût de $:price pour retirer la marque de Hype Sri Lanka des factures et du portail client.',
    ...
    'pro_plan_remove_logo' => ':link pour supprimer le logo Hype Sri Lanka en souscrivant au Plan Pro',
    ...
    'pro_plan_year_description' => 'Engagement d\'un an dans le Plan Hype Sri Lanka Pro.',
    'pro_plan_month_description' => 'Engagement d\'un mois dans le Plan Hype Sri Lanka Pro.',
    'enterprise_plan_product' => 'Plan Entreprise',
    'enterprise_plan_year_description' => 'Engagement d\'un an dans le Plan Hype Sri Lanka Entreprise.',
    'enterprise_plan_month_description' => 'Engagement d\'un mois dans le Plan Hype Sri Lanka Entreprise.',
...
Lorsque les montant apparaîtront sur votre relevé, veuillez revenir sur cette page et cliquez sur "Compléter la vérification" à côté du compte.',
    ...
    'export_help' => 'Utilisez JSON si vous prévoyez d\'importer des données dans Hype Sri Lanka.<br/>Le fichier inclut les clients, les produits, les factures, les offres et les paiements.',
    ...
    'wepay_account_description' => 'Passerelle de paiement pour Hype Sri Lanka',
    ...
    'bot_get_email' => 'Salut! (wave)<br/>Merci d\'essayer le Bot Hype Sri Lanka.<br/>Vous devez créer un compte gratuit pour utiliser ce bot.<br/>Envoyez-moi l\'adresse courriel de votre compte pour commencer.',
    ...
    'security_code_email_subject' => 'Code de sécurité pour le Bot de Hype Sri Lanka',
    'security_code_email_line1' => 'Ceci est votre code de sécurité pour le Bot de Hype Sri Lanka.',
    ...
    'update_invoiceninja_title' => 'Mettre à jour Hype Sri Lanka',
    'update_invoiceninja_warning' => 'Avant de commencer une mise à jour d\'Hype Sri Lanka, créez une sauvegarde de votre base de données et de vos fichiers!',
    'update_invoiceninja_available' => 'Une nouvelle version de Hype Sri Lanka est disponible.',
    'update_invoiceninja_unavailable' => 'Aucune mise à jour de Hype Sri Lanka disponible.',
...
<ul><li>Marges de crédit et affacturage d\'affaires flexibles.</li></ul>',
    ...
    'migrate_to_next_version' => 'Migrer dans la nouvelle version d\'Hype Sri Lanka.',
    'migrate_intro_text' => 'Nous avons travaillé sur une nouvelle version de Hype Sri Lanka. Cliquez sur le bouton ci-dessous pour démarrer la migration.',
    'start_the_migration' => 'Démarrer la migration',
    'migration' => 'Migration',
    'welcome_to_the_new_version' => 'Bienvenue dans la nouvelle version d\'Hype Sri Lanka',
