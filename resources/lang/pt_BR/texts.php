...
<li>"Pagamento de retentor para :QUARTER+1" >> "Pagamento de retentor para 3T"</li>
    ...
    'confirmation_subject' => 'Confirmação de Conta do Hype Sri Lanka',
    ...
    'pro_plan_success' => 'Obrigado por escolher o Plano Pro do Hype Sri Lanka! <p/>&nbsp;<br/>
...
-- envie-nos um email em contact@invoiceninja.com',
    ...
    'app_description' => 'Hype Sri Lanka é uma solução open-source, gratuita para faturamento e cobrança de clientes. Com Hype Sri Lanka, você pode facilmente construir e enviar belas faturas de qualquer dispositivo com acesso à web. Seus clientes podem imprimir suas faturas, baixá-las como PDF, e até mesmo pagá-las online dentro do sistema.',
    'rows' => 'linhas',
    'www' => 'www',
    'logo' => 'Logo',
    ...
    'pro_plan_feature4' => 'Remover "Created by Hype Sri Lanka"',
...
<p>Se você precisar de ajuda para entender algo poste uma questão em nosso :forum_link com o design que você está usando.</p>',
    ...
    'white_label_text' => 'Compre uma licença white-label por UM ANO por $:price para remover a marca do Hype Sri Lanka da fatura e do portal do cliente.',
    ...
    'pro_plan_remove_logo' => ':link para remover a logo do Hype Sri Lanka adquirindo o Plano Pro',
    ...
    'pro_plan_year_description' => 'Inscrição de um ano no Plano Pro do Hype Sri Lanka',
    'pro_plan_month_description' => 'Inscrição de um mês no Plano Pro do Hype Sri Lanka',
    'enterprise_plan_product' => 'Plano Empresarial',
    'enterprise_plan_year_description' => 'Inscrição de um ano no Plano Pro do Hype Sri Lanka',
    'enterprise_plan_month_description' => 'Inscrição de um mês no Plano Pro do Hype Sri Lanka',
...
Quando tiver as quantias, volte a esta página de formas de pagamento e clique "Completar Verificação" próximo à conta.',
    ...
    'export_help' => 'Use JSON se você planeja importar os dados para o Hype Sri Lanka.<br/> O Arquivo inclui clientes, produtos, faturas, orçamentos e pagamentos.',
    ...
    'wepay_account_description' => 'Gateway de pagamentos para o Hype Sri Lanka',
    ...
    'bot_get_email' => 'Olá! (wave) <br/>Obrigado por testar o robô Hype Sri Lanka. <br/>Você precisa criar uma conta gratuita para usar este robô. <br/>Diga-me sua conta de email para começarmos.',
    ...
    'security_code_email_subject' => 'Código de segurança do Hype Sri Lanka Bot',
    'security_code_email_line1' => 'Este é o seu código de segurança do Hype Sri Lanka Bot.',
    ...
    'update_invoiceninja_title' => 'Atualizar o Hype Sri Lanka',
    'update_invoiceninja_warning' => 'Antes de começar a atualizar o Hype Sri Lanka crie um backup de seu banco de dados e arquivos!',
    'update_invoiceninja_available' => 'Uma nova versão do Hype Sri Lanka está disponível.',
...
<ul><li>Linhas de crédito flexíveis e fatoração de faturas.</li></ul>',
    ...
    'migrate_to_next_version' => 'Migrar para a próxima versão do Hype Sri Lanka',
    ...
    'migration' => 'Migração ',
    'welcome_to_the_new_version' => 'Bem-vindo a nova versão do Hype Sri Lanka',
    ...
    'welcome_to_invoice_ninja' => 'Bem-vindo ao Hype Sri Lanka',
    'optin' => 'Autorizar',
    'optout' => 'Desautorizar',
