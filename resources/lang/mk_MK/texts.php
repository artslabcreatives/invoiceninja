...
<li> "Задржано плаќање за :QUARTER+1" >> "Задржано плаќање за К2" </li>
    ...
    'confirmation_subject' => 'Потврдување на Hype Sri Lanka сметка',
    ...
    'email_from' => 'Тимот на Hype Sri Lanka',
    ...
    'pro_plan_success' => 'Ви благодариме што го избравте Про планот на Hype Sri Lanka! <p/> &nbsp; <br/>
 ...
 --пратете ни е-пошта на contact@invoiceninja.com',
    ...
    'app_description' => 'Hype Sri Lanka е бесплатно, отворено решение за фактурирање и наплата на клиенти. Со Hype Sri Lanka, можете лесно да создадете и да пратите прекрасни фактури од било кој уред кој има пристап до веб. Вашите клиенти можат да ја испечатат фактурата, да ја преземат како pdf датотека и дури да платат онлајн во системот.',
    'rows' => 'Редови',
    'www' => 'www',
    'logo' => 'Лого',
    'subdomain' => 'Поддомен',
    ...
    'pro_plan_feature4' => 'Отстрани "Креирано со Hype Sri Lanka"',
 ...
 <li> Денес е петок, датумот на достасување е првиот петок потоа. Датумот на достасување би бил наредниот петок, не денес. 
    ...
    'white_label_text' => 'Купете ЕДНОГОДИШЕН ПЛАН за брендирана лиценца за $:price за да го отстраните брендирањето на Hype Sri Lanka од клиентскиот портал.',
    ...
    'pro_plan_remove_logo' => ':link за отстранување на Hype Sri Lanka логото со приклучување на Pro планот',
    ...
    'pro_plan_year_description' => 'Една година запишување на Hype Sri Lanka Pro планот.',
    'pro_plan_month_description' => 'Еден месец запишување на Hype Sri Lanka Pro планот.',
    'enterprise_plan_product' => 'План за претпријатие',
    'enterprise_plan_year_description' => 'Една година запишување на Hype Sri Lanka Pro планот за претпријатие.',
    'enterprise_plan_month_description' => 'Еден месец запишување на Hype Sri Lanka Pro планот за претпријатие.',
...
Откако ќе ги добиете износите, вратете се на оваа страница за начин на плаќање и кликнете "Заврши Верификација" до сметката.',
    ...
    'export_help' => 'Користи JSON ако планираш да ги внесеш информациите во Hype Sri Lanka. <br/> Датотеката содржи клиенти, продукти, фактури, понуди и плаќања.',
    ...
    'wepay_account_description' => 'Платен портал за Hype Sri Lanka',
    ...
    'bot_get_email' => 'Здраво! (wave) <br/> Ви благодарам што го пробавте Hype Sri Lanka ботот. <br/> Треба да креирате бесплатна сметка за да го користите овој бот. <br/> Испратете ми ја адресата на вашата е-пошта со која е поврзана сметката за да започнеме.',
    ...
    'security_code_email_subject' => 'Сигурносен код за Hype Sri Lanka ботот',
    'security_code_email_line1' => 'Ова е вашиот Hype Sri Lanka Bot сигурносен код.',
    ...
    'update_invoiceninja_title' => 'Ажурирај Hype Sri Lanka',
    'update_invoiceninja_warning' => 'Пред за започнете со ажурирање на Hype Sri Lanka креирајте бекап на вашата датабаза и датотеки.',
    'update_invoiceninja_available' => 'Достапна е нова верзија на Hype Sri Lanka.',
    'update_invoiceninja_unavailable' => 'Нема достапна нова верзија на Hype Sri Lanka.',
