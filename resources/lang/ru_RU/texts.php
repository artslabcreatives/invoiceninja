...
<li>"Вознаграждение за  :QUARTER+1 квартал" => "Вознаграждение за 2 квартал"</li>
    ...
    'confirmation_subject' => 'Подтверждение учетной записи Hype Sri Lanka',
    ...
    'agree_to_terms' => 'Я согласен с условиями Hype Sri Lanka :terms ',
    ...
    'pro_plan_success' => 'Спасибо, что выбрали Pro план Hype Sri Lanka!<p/>&nbsp;<br/>
...
-- напишите нам письмо на contact@invoiceninja.com',
    ...
    'app_description' => 'Hype Sri Lanka - бесплатное решение с открытым исходным кодом для выставления счетов клиентам и получения платежей. С помощью Hype Sri Lanka вы можете легко создавать и отправлять красивые счета-фактуры с любого устройства, имеющего доступ к сети. Ваши клиенты смогут печатать ваши счета-фактуры, загружать их в виде pdf-файлов и даже оплачивать онлайн в системе.',
    'rows' => 'строк',
    'www' => 'www',
    'logo' => 'Логотип',
    'subdomain' => 'Поддомен',
    ...
    'pro_plan_feature4' => 'Удалить "Created by Hype Sri Lanka"',
...
Успешно созданы  :count_vendors Поставщик(и) и  :count_expenses и расход(ы)',
    ...
    'export_help' => 'Используйте JSON если вы планируете импортировать данные в Hype Sri Lanka.<br/>Файл вклчает клиентов, товары/услуги, счета, прайс-листы и платежи.',
