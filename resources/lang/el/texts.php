...
<li>"Προκαταβολή πληρωμής για το :QUARTER+1" >> "Προκαταβολή πληρωμής για το Τρίμηνο 2"</li>
    ...
    'confirmation_subject' => 'Επιβεβαίωση Λογαριασμού Hype Sri Lanka',
    ...
    'email_from' => 'Η Ομάδα του Hype Sri Lanka',
    ...
    'pro_plan_success' => 'Ευχαριστούμε που επιλέξατε το Hype Sri Lanka\'s Pro plan!<p/>&nbsp;<br/>
...
να σας βοηθήσουμε. Στείλτε μας email στο contact@invoiceninja.com\',',
    ...
    'pro_plan_feature4' => 'Αφαίρεση του "Created by Hype Sri Lanka"',
    ...
    'pro_plan_remove_logo' => ':link για να αφαιρέσετε το λογότυπο Hype Sri Lanka και να συμμετέχετε στο Επαγγελματικό Πλάνο',
    ...
    'pro_plan_year_description' => 'Ένα έτος εγγραφή στο Επαγγελματικό Πλάνο του Hype Sri Lanka.',
    'pro_plan_month_description' => 'Ένας μήνας εγγραφή στο Επαγγελματικό Πλάνο του Hype Sri Lanka.',
    'enterprise_plan_product' => 'Πλάνο Enterprise',
    'enterprise_plan_year_description' => 'Ένα έτος εγγραφή στο Εταιρικό Πλάνο του Hype Sri Lanka.',
    'enterprise_plan_month_description' => 'Ένας μήνας εγγραφή στο Εταιρικό Πλάνο του Hype Sri Lanka.',
    ...
    'export_help' => 'Χρησιμοποιήστε JSON εάν σχεδιάζετε να εισάγετε δεδομένα στο Hype Sri Lanka.<br/>Το αρχείο περιλαμβάνει πελάτες, προϊόντα, τιμολόγια, προσφορές και πληρωμές.',
    ...
    'wepay_account_description' => 'Πύλη Πληρωμών (Gateway) για το Hype Sri Lanka',
    ...
    'bot_get_email' => 'Γειά! (wave)<br/>Ευχαριστώ που δοκιμάσατε τον αυτοματισμό του Hype Sri Lanka.<br/>Θα πρέπει να δημιουργήσετε ένα δωρεάν λογαριασμό για να χρησιμοποιήσετε αυτό τον αυτοματισμό.<br/>Στείλτε μου την διεύθυνση email σας για να ξεκινήσετε.',
    ...
    'security_code_email_subject' => 'Κωδικός ασφαλείας για τον αυτοματισμό Hype Sri Lanka',
    'security_code_email_line1' => 'Αυτός είναι ο κωδικός ασφαλείας για τον αυτοματισμό Hype Sri Lanka',
    ...
    'update_invoiceninja_title' => 'Ενημέρωση Hype Sri Lanka',
    'update_invoiceninja_warning' => 'Πριν αρχίσετε την αναβάθμιση του Hype Sri Lanka, δημιουργήστε ένα αντίγραφο ασφαλείας της βάσης δεδομένων και των αρχείων!',
    'update_invoiceninja_available' => 'Υπάρχει διαθέσιμη νεότερη έκδοση του Hype Sri Lanka.',
    'update_invoiceninja_unavailable' => 'Δεν υπάρχει νεότερη έκδοση του Hype Sri Lanka διαθέσιμη.',
...
<ul><li>Ευέλικτες πιστωτικές λύσεις και factoring τιμολογίων.</li></ul>',
    ...
    'migrate_to_next_version' => 'Μεταφερθείτε στην επόμενη έκδοση του Hype Sri Lanka',
    'migrate_intro_text' => 'Εργαζόμαστε για την επόμενη έκδοση του Hype Sri Lanka. Πατήστε το κουμπί παρακάτω για να ξεκινήσετε τη μεταφορά.',
    'start_the_migration' => 'Ξεκινήστε τη μεταφορά',
    'migration' => 'Μεταφορά',
    'welcome_to_the_new_version' => 'Καλωσήρθατε στην επόμενη έκδοση του Hype Sri Lanka ',
    ...
    'welcome_to_invoice_ninja' => 'Καλωσήρθατε στο Hype Sri Lanka ',
    'optin' => 'Συμμετοχή',
    'optout' => 'Μη Συμμετοχή',
