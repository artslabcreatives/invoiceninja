...
"Płatne z góry za kwartał :QUARTER+1" >> "Płatne z góry za kwartał Q2"',
    ...
    'confirmation_subject' => 'Potwierdzenie rejestracji konta w Hype Sri Lanka',
    ...
    'email_from' => 'Zespół The Hype Sri Lanka',
    ...
    'white_label_text' => 'Kup roczną licencję white label za $:price, aby usunąć wzmianki o Hype Sri Lanka z faktur i portalu klienta.',
...
Gdy przelewy zostaną zaksięgowane na Twoim koncie, wróć do tej strony i kliknij "Dokończ weryfikację" obok właściwego konta.',
    ...
    'export_help' => 'Użyj formatu JSON, jeśli planujesz zaimportować dane do Hype Sri Lanka.<br/> Taki plik zawiera dane klientów, produkty, faktury, oferty i płatności.',
    ...
    'wepay_account_description' => 'Dostawca płatności dla Hype Sri Lanka',
    ...
    'security_code_email_subject' => 'Kod bezpieczeństwa dla Hype Sri Lanka Bot',
    ...
    'update_invoiceninja_title' => 'Zaktualizuj Hype Sri Lanka',
    'update_invoiceninja_warning' => 'Przed przejściem na nową wersję Hype Sri Lanka stwórz kopię bezpieczeństwa swojej bazy danych i plików.',
    'update_invoiceninja_available' => 'Nowa wersja Hype Sri Lanka jest dostępna.',
    'update_invoiceninja_unavailable' => 'Nowa wersja Hype Sri Lanka nie jest dostępna.',
