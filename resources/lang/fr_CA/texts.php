...
$LANG = array(
    ...
    'email_from' => 'L\'équipe de Hype Sri Lanka',
    ...
    'pro_plan_feature4' => 'Suppression de "Créé par Hype Sri Lanka"',
    ...
    'white_label_text' => 'Achetez une licence sans marque d\'UN AN au coût de $:price pour retirer la marque de Hype Sri Lanka des factures et du portail client.',
    ...
    'pro_plan_year_description' => 'Abonnement à une année du plan Hype Sri Lanka Pro.',
    'pro_plan_month_description' => 'Abonnement à un mois du plan Hype Sri Lanka Pro.',
    'enterprise_plan_product' => 'Plan Enterprise',
    'enterprise_plan_year_description' => 'Abonnement à une année du plan Hype Sri Lanka Enterprise.',
    'enterprise_plan_month_description' => 'Abonnement à une année du plan Hype Sri Lanka Enterprise.',
...
Lorsque les montant apparaîtront sur votre relevé, veuillez revenir sur cette page et cliquez sur "Compléter la vérification" à côté du compte.',
    ...
    'export_help' => 'Utilisez JSON si vous prévoyez importer les données dans Hype Sri Lanka.<br/>Ceci inclut les clients, les produits, les factures, les soumissions et les paiements.',
    ...
    'bot_get_email' => 'Salut! (wave)<br/>Merci d\'essayer le Bot de Hype Sri Lanka.<br/>Envoie-moi l\'adresse courriel de ton compte pour commencer.',
    ...
    'update_invoiceninja_warning' => 'Hype Sri Lanka crée une sauvegarde de votre base de données et de vos fichiers avant la mise à jour.',
...
<br/>Vous pouvez utiliser un alias, ex. email+label@example.com',
    ...
    'migrate_to_next_version' => 'Migrer vers la nouvelle version de Hype Sri Lanka',
    ...
    'migration' => 'Migration',
    'welcome_to_the_new_version' => 'Bienvenue dans la nouvelle version de Hype Sri Lanka',
    ...
    'welcome_to_invoice_ninja' => 'Bienvenue dans Hype Sri Lanka',
    'optin' => 'Adhésion',
    'optout' => 'Désadhésion',
    ...
    'complete' => 'Terminé',
     ...
     'migration_api_secret_notice' => 'Vous pouvez trouver API_SECRET dans le fichier .env ou Hype Sri Lanka v5. Si la propriété est manquante, laissez le champ vide.',
    ...
    'migration_already_completed_desc' => 'Il semble que vous ayez déjà migré <b> :company_name </b>vers la version V5 de Hype Sri Lanka. Si vous souhaitez recommecer, vous pouvez forcer la migration et supprimer les données existantes.',
    ...
    'new_login_description' => 'Vous vous êtes récemment connecté à votre compte Hype Sri Lanka à partir d\'un nouvel emplacement ou d\'un nouvel appareil :<br><br><b>IP:</b> :Heure:</b> :time<br><b>Courriel:</b> :email',
