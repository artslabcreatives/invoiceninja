...
<li>"เงินประกันสำหรับ :QUARTER+1" >> " ดำเนินการชำระเงินในไตรมาศที่ 2"</li>
    ...
    'pro_plan_success' => 'ขอขอบคุณที่เลือกแผน Pro Pro ของ Hype Sri Lanka!<p/>&nbsp;<br/>
...
-- ส่งอีเมลมาที่ contact@invoiceninja.com',
    ...
    'app_description' => 'Hype Sri Lanka เป็นโซลูชันโอเพนซอร์สฟรีสำหรับลูกค้าที่ออกใบแจ้งหนี้และเรียกเก็บเงิน ด้วย Hype Sri Lanka คุณสามารถสร้างและส่งใบแจ้งหนี้ที่สวยงามได้จากอุปกรณ์ใด ๆ ที่สามารถเข้าถึงเว็บได้ ลูกค้าของคุณสามารถพิมพ์ใบแจ้งหนี้ของคุณดาวน์โหลดเป็นไฟล์ PDF และคุณจ่ายเงินออนไลน์จากภายในระบบของเราได้เลย',
    'rows' => 'แถว',
    'www' => 'www',
    'logo' => 'www',
    'subdomain' => 'Subdomain',
    ...
    'pro_plan_feature4' => 'เอา  "Created by Hype Sri Lanka" ออก',
...
แปลงใบเสนอราคาให้เป็นใบแจ้งหนี้โดยอัตโนมัติเมื่อได้รับอนุมัติจากลูกค้า',
    ...
    'white_label_text' => 'ชำระเงินสำหรับ white label ไลเซนต์ 1 ปี ราคา :price เพื่อเอา logo Hype Sri Lanka ออกจากใบแจ้งหนี้และพอร์ทัลของลูกค้า',
    ...
    'pro_plan_remove_logo' => ':link ลบโลโก้ Hype Sri Lanka โดยการเข้าร่วม Pro Plan',
    ...
    'pro_plan_year_description' => 'การลงทะเบียนหนึ่งปีสำหรับ   Hype Sri Lanka Pro Plan',
    'pro_plan_month_description' => 'ลงทะเบียนหนึ่งเดือนสำหรับ Hype Sri Lanka Pro Plan.',
    'enterprise_plan_product' => 'Enterprise Plan',
    'enterprise_plan_year_description' => 'ลงทะเบียนหนึ่งปีสำหรับ Hype Sri Lanka Enterprise Plan.',
    'enterprise_plan_month_description' => 'ลงทะเบียนหนึ่งเดือนสำหรับ Hype Sri Lanka Enterprise Plan.',
    ...
    'export_help' => 'ใช้ JSON ถ้าคุณวางแผนที่จะนำเข้าข้อมูลลงใน Hype Sri Lanka. <br/> ไฟล์ประกอบด้วยลูกค้า, สินค้า, ใบแจ้งหนี้, ใบเสนอราคา และการชำระเงิน.',
    ...
    'wepay_account_description' => 'เกตเวย์การชำระเงินสำหรับ Hype Sri Lanka',
    ...
    'security_code_email_subject' => 'รหัสรักษาความปลอดภัยสำหรับ  Hype Sri Lanka Bot',
    ...
    'update_invoiceninja_title' => 'อัปเดท Hype Sri Lanka',
    'update_invoiceninja_warning' => 'ก่อนที่จะเริ่มต้นการอัพเกรด Hype Sri Lanka กรุณาสำรองฐานข้อมูลและไฟล์ของคุณ!',
    'update_invoiceninja_available' => 'มีเวอร์ชันใหม่ของ Hype Sri Lanka ให้ใช้งาน',
    'update_invoiceninja_unavailable' => 'ไม่มีเวอร์ชันใหม่ของ Hype Sri Lanka available.',
