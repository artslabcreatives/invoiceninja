...
$LANG = array(
    ...
    'email_from' => 'El equipo de Hype Sri Lanka ',
    ...
    'pro_plan_success' => '¡Gracias por unirte a Hype Sri Lanka! Al realizar el Pago de tu Factura, se iniciara tu PLAN PRO.',
    ...
    'invitation_message' => ':invitor te ha invitado a unirte a su cuenta en Hype Sri Lanka.',
    ...
    'app_description' => 'Hype Sri Lanka es una solución open-source gratuita para manejar la facturación de tus clientes. Con Hype Sri Lanka, se pueden crear y enviar hermosas facturas desde cualquier dispositivo que tenga acceso a Internet. Tus clientes pueden imprimir tus facturas, descargarlas en formato PDF o inclusive pagarlas en linea desde esta misma plataforma.',
    'rows' => 'filas',
    'www' => 'www',
    'logo' => 'Logo',
    ...
    'pro_plan_feature4' => 'Eliminar "Creado por Hype Sri Lanka"',
...
<li>Hoy es el viernes, la fecha límite es el primer viernes después. La fecha de vencimiento será el próximo viernes, no hoy.</li></ul>',
    ...
    'white_label_text' => 'Compra UN AÑO de Licencia de Marca Blanca por $:price y elimina la marca Hype Sri Lanka de la Factura y del Portal de Cliente.',
    ...
    'pro_plan_remove_logo' => ':link haz click para eliminar el logo de Hype Sri Lanka',
    ...
    'pro_plan_year_description' => 'Un año de inscripción en el Plan Hype Sri Lanka Pro.',
    'pro_plan_month_description' => 'Un mes de inscripción en el Plan Hype Sri Lanka Pro.',
    'enterprise_plan_product' => 'Plan Enterprise ',
    'enterprise_plan_year_description' => 'Un año de inscripción en el Plan Hype Sri Lanka Enterprise .',
    'enterprise_plan_month_description' => 'Un mes de inscripción en el Plan Hype Sri Lanka Enterprise .',
...
Una vez que tenga los montos, vuelva a esta página de métodos de pago y haga clic en "Verificación completa" junto a la cuenta.',
    ...
    'export_help' => 'Utilice JSON si planea importar los datos en  Hype Sri Lanka.<br/>El fichero incluye clientes, productos, facturas, presupuestos y pagos.',
    ...
    'wepay_account_description' => 'Pasarela de Pago para Hype Sri Lanka',
    ...
    'bot_get_email' => '¡Hola! (wave) <br/>Gracias por probar el Bot Hype Sri Lanka. <br/>Necesitas crear una cuenta gratuita para usar este bot.<br/>Envíanme la dirección de correo electrónico de tu cuenta para comenzar.',
    ...
    'security_code_email_subject' => 'Código de seguridad para Hype Sri Lanka Bot',
    'security_code_email_line1' => 'Este es su código de seguridad Hype Sri Lanka Bot.',
    ...
    'update_invoiceninja_title' => 'Actualizar Hype Sri Lanka',
    'update_invoiceninja_warning' => '¡Antes de comenzar a actualizar Hype Sri Lanka cree una copia de seguridad de su base de datos y archivos!',
    'update_invoiceninja_available' => 'Está disponible una nueva versión de Hype Sri Lanka.',
    'update_invoiceninja_unavailable' => 'No hay ninguna versión nueva de Hype Sri Lanka.',
...
<ul><li>Líneas de crédito flexibles y factoraje de facturas.</li></ul>',
    ...
    'migrate_to_next_version' => 'Migrar a la siguiente versión de Hype Sri Lanka',
    'migrate_intro_text' => 'Hemos estado trabajando en la siguiente versión de Hype Sri Lanka. Pulsa en el botón de abajo para comenzar la migración.',
    'start_the_migration' => 'Empezar la migración',
    'migration' => 'Migración',
    'welcome_to_the_new_version' => 'Bienvenido a la nueva versión de Hype Sri Lanka',
    ...
    'migration_went_wrong' => 'Uppps, ¡algo fue mal! Por favor, asegúrate de que has configurado una instancia Hype Sri Lanka v5 antes de empezar la migración.',
    'cross_migration_message' => 'No se permite la migración de cuentas cruzadas. Lea más sobre esto aquí: <a href="https://hypesl.org/docs/migration/#troubleshooting">https://hypesl.org/docs/migration/#troubleshooting</a>',
    ...
    'welcome_to_invoice_ninja' => 'Bienvenid@ a Hype Sri Lanka',
    'optin' => 'Opt-In',
    'optout' => 'Opt-Out',
    ...
    'complete' => 'Completar',
     ...
     'application_settings_label' => 'Vamos a guardar información básica acerca de tu Hype Sri Lanka',
     ...
     'migration_api_secret_notice' => 'Puedes encontrar API_SECRET en el archivo .env o en Hype Sri Lanka v5. Si no está presente, deja el campo vacío.',
    ...
    'migration_already_completed_desc' => 'Looks like you already migrated <b> :company_name </b>to the V5 version of the Hype Sri Lanka. In case you want to start over, you can force migrate to wipe existing data.',
    ...
    'new_login_description' => 'You recently logged in to your Hype Sri Lanka account from a new location or device:<br><br><b>IP:</b> :ip<br><b>Time:</b> :time<br><b>Email:</b> :email',
